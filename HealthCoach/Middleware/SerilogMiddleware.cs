...
/// <summary>
/// Found from: http://blog.getseq.net/smart-logging-middleware-for-asp-net-core/
/// </summary>
namespace HealthCoach.Middleware
{
    class SerilogMiddleware
    {
        const string MessageTemplate =
            "HTTP {RequestMethod} {RequestPath} responded {StatusCode} in {Elapsed:0.0000} ms {RequestText}";
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                ...
                log.Write(level, MessageTemplate, httpContext.Request.Method, httpContext.Request.Path, statusCode, sw.Elapsed.TotalMilliseconds, requestBodyText);
